...
proxychains xfreerdp /v:<ip> /u:htb-student /p:HTB_@cademy_stdnt!	Launches an RDP session routed through the SOCKS proxy. This is useful for interacting with internal desktops (like domain-joined Windows 